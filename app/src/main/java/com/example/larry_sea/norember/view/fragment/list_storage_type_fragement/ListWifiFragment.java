...
import com.example.larry_sea.norember.adapter.FragmentListWifiAdapter;
 ...
 * <p>
 * wifiType 的list fragment
 */

public class ListWifiFragment extends Fragment implements RecyclerviewClickInterface {
    @BindView(R.id.id_fragment_sticky_recyclerview)
    RecyclerView mrecyclerview;
    RealmResults<Wifiinfor> realmResults;
    FragmentListWifiAdapter stickListFragmentAdapter;
    Realm mrealm;                                         // realm
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        stickListFragmentAdapter = new FragmentListWifiAdapter(getActivity(), realmResults);
    ...
    *
    * */
    public void initData(RealmResults<Wifiinfor> bankCardRealmResults) {
        mrealm = Realm.getDefaultInstance();
        mrealm.executeTransaction(new Realm.Transaction() {
            @Override
            public void execute(Realm realm) {
                realmResults = realm.where(Wifiinfor.class).findAll();
            }
        });
    ...
    public void onClick(View view, int position) {
        ...
        message.obj = realmResults.get(position).getWifiName();
