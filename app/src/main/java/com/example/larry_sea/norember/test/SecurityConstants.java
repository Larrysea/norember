 ...
 * This class should not be considered a complete list of the algorithms, keys tore types,
...
public class SecurityConstants {
    ...
    public static final String REALM_ALIAS = "NO_REMBER_ALIAS";           //norember的别名
}
