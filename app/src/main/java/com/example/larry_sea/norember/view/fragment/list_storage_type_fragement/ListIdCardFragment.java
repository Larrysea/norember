...
import com.example.larry_sea.norember.adapter.FragmentListIdCardAdapter;
 ...
 * <p>
 * <p>
 * 身份证额的list card fragment
 */

public class ListIdCardFragment extends Fragment implements RecyclerviewClickInterface {

    @BindView(R.id.id_fragment_sticky_recyclerview)
    RecyclerView mrecyclerview;
    RealmResults<IdentityCard> realmResults;
    FragmentListIdCardAdapter stickListFragmentAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        stickListFragmentAdapter = new FragmentListIdCardAdapter(getActivity(), realmResults);
    ...
    *
    * */
    public void initData(RealmResults<IdentityCard> bankCardRealmResults) {

        mrealm = Realm.getDefaultInstance();
        mrealm.executeTransaction(new Realm.Transaction() {
            @Override
            public void execute(Realm realm) {
                realmResults = realm.where(IdentityCard.class).findAll();
            }
        });
    ...
    public void onClick(View view, int position) {
        ...
        message.obj = realmResults.get(position).getIdentityNumber();
