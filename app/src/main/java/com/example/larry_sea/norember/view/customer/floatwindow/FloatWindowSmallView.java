...
public class FloatWindowSmallView extends LinearLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if ((xDownInScreen - xInScreen) < 15 && (yDownInScreen - yInScreen) < 15) {
    ...
    /**
     * 检查是否是合法用户如果是合法用户显示密码填充功能，
     * 如果是非法用户则不显示密码填充功能
     *
     *
     */
    private void checkIsIllegalUser() {
        Intent intent = new Intent(mContext, LockScreenActivity.class);
        intent.putExtra("call_source", FloatWindowSmallView.class.toString());
