...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_SECURE);
    ...
    public void initView() {
        ...
        if (mbundle != null) {
            mbundle.putString("isEdit", "edit_flag");
            loginInforFragment.setArguments(mbundle);
        }
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.id_fragment_container, loginInforFragment, "loginInforFragment");
    ...
    public void onResume() {
        super.onResume();
        if (isLocked)
            startActivityForResult(new Intent(AddWebSiteInforActivity.this, LockScreenActivity.class), 1);
    }
    ...
    protected void onStop() {
        super.onStop();
        if (ApplicationUtil.isApplicationInBackground(AddWebSiteInforActivity.this)) {
            isLocked = true;
        }
    }
